...
export const adPositions: AdPosition[] = [
  ...
  { id: 'POS-004', name: 'Email Newsletter', location: 'E-Mail Newsletter', dimensions: '600 × 300 px', pricePerMonth: 199, available: true },
...
export const adApplications: AdApplication[] = [
  { id: 'APP-001', companyName: 'Continental Reifen GmbH', contactPerson: 'Markus Weber', email: 'm.weber@continental.de', phone: '+49 521 93880', website: 'https://continental.de', description: 'Wir möchten unsere neue Generation Truck-Reifen auf der CargoBit-Plattform bewerben.', targetAudience: ['dispatcher', 'admin', 'finance'], budgetRange: '€1.000 – €3.000/Monat', preferredPositions: ['Header Banner', 'Dashboard Widget'], status: 'approved', submittedAt: '2024-12-10T10:00:00Z' },
  ...
  { id: 'APP-003', companyName: 'BP Europa SE', contactPerson: 'Thomas Richter', email: 't.richter@bp.com', phone: '+49 211 37770', website: 'https://bp.de/fleet', description: 'BP Fuel Cards für Fuhrparkbetreiber bewerben.', targetAudience: ['admin', 'dispatcher', 'finance'], budgetRange: '€500 – €1.500/Monat', preferredPositions: ['Sidebar Banner', 'Email Newsletter'], status: 'pending', submittedAt: '2024-12-15T09:00:00Z' },
